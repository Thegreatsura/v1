...
const footerLinks = {
  ...
  resources: [
    { label: "Docs", href: "https://modelcontextprotocol.io/docs", external: true },
      ...
      <div className="container-page py-12 md:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-subtle text-xs mt-4 leading-relaxed">
          ...
          {/* Product Column */}
          <div>
            <h3 className="label mb-4">Product</h3>
                ...
                <li key={link.href}>
                  {"external" in link && link.external ? (
                    <a
                      ...
                      className="text-muted text-sm hover:text-foreground transition-colors inline-flex items-center gap-1.5"
                    >
                      {link.label}
